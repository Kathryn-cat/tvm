...
class StaticMatmulModule:
    @T.prim_func
    def main(
        A: T.Buffer[(1024, 512), "float16"],
        B: T.Buffer[(512, 1024), "float16"],
        C: T.Buffer[(1024, 1024), "float16"],
    ) -> None:
        # function attr dict
        T.func_attr({"global_symbol": "static_matmul_module", "tir.noalias": True})
        a0 = T.var("int32")
        a1 = T.var("int32")
        b0 = T.var("int32")
        b1 = T.var("int32")
        ...
        A_reindex_shared = T.alloc_buffer([1024, 512], dtype="float16", scope="shared")
        B_reindex_shared = T.alloc_buffer([512, 1024], dtype="float16", scope="shared")
        A_reindex_shared_wmma_matrix_a = T.alloc_buffer(
            [1024, 512], dtype="float16", scope="wmma.matrix_a"
        )
        B_reindex_shared_wmma_matrix_b = T.alloc_buffer(
            [512, 1024], dtype="float16", scope="wmma.matrix_b"
        )
                        ...
                        for ax2_0_1 in T.serial(1):
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("A_reindex_shared_wmma.matrix_a_o"):
                                    ...
                                    v1_o = T.axis.spatial(32, ax2_0_0 * 2 + ax1_0)
                                    T.reads(
                                        A_reindex_shared[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                                        ]
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("B_reindex_shared_wmma.matrix_b_o"):
                                    v0_o = T.axis.spatial(32, ax2_0_0 * 2 + ax0_0)
                                    v1_o = T.axis.spatial(
                                        64,
                                        ax0_0_0_ax1_0_0_fused % 8 * 8
                                        + ax0_0_1_ax1_0_1_fused * 2
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(
                                ...
                                with T.block("C_o_update"):
                                    ...
                                    v2_o = T.axis.reduce(32, ax2_0_0 * 2 + ax2_0_1 * 2 + ax2_0_2)
                                    T.reads(
                                        C_reindex_shared_wmma_accumulator[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                                        ],

...
class Microkernel_128_64_32:
    ...
    def main(
        ...
        C_reindex_shared_wmma_accumulator = T.alloc_buffer(
            [128, 64], dtype="float16", scope="wmma.accumulator"
        )
                ...
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(1, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(
                        ...
                        with T.block("C_o_init"):
                            ...
                            v1_o = T.axis.spatial(
                                4, ax0_0_0_ax1_0_0_fused % 4 + ax1_0_3_init + ax1_0_4_init
                            )
                            T.reads()
                            T.writes(
                        ...
                        for ax2_0_1 in T.serial(2):
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 1):
                                with T.block("B_reindex_shared_wmma.matrix_b_o"):
                                    ...
                                    v1_o = T.axis.spatial(4, ax0_0_0_ax1_0_0_fused % 4)
                                    T.reads(
                                        B_reindex_shared[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                                        ]
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(
                                ...
                                with T.block("C_o_update"):
                                    ...
                                    v1_o = T.axis.spatial(
                                        4, ax0_0_0_ax1_0_0_fused % 4 + ax1_0_3 + ax1_0_4
                                    )
...
def apply_trace(sch: tir.Schedule) -> None:
    ...
    v24, v25, v26, v27, v28 = sch.sample_perfect_tile(
        loop=l21, n=5, max_innermost_factor=4, decision=[4, 2, 1, 1, 1]
    )
...
-----------------------------------------------------------------------------------------------------
  0 | main | 524288 |      1 |       233.2272 |       2.2480 |                2.2480 |   1000 |    Y
-----------------------------------------------------------------------------------------------------
Total trials: 1000
Total latency (us): 2.24797

best tuning record is 0, min_run_time is 2.247971535795893e-06
"""

...
class Microkernel_64_64_32:
    ...
    def main(
        ...
        C_reindex_shared_wmma_accumulator = T.alloc_buffer(
            [64, 64], dtype="float16", scope="wmma.accumulator"
        )
        A_reindex_shared = T.alloc_buffer([64, 32], dtype="float16", scope="shared")
        B_reindex_shared = T.alloc_buffer([32, 64], dtype="float16", scope="shared")
        ...
        B_reindex_shared_wmma_matrix_b = T.alloc_buffer(
            [32, 64], dtype="float16", scope="wmma.matrix_b"
        )
                ...
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(1, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(
                        ...
                        with T.block("C_o_init"):
                            v0_o = T.axis.spatial(
                                4, ax0_0_4_init + ax0_0_1_ax1_0_1_fused + ax0_0_3_init
                            )
                            v1_o = T.axis.spatial(
                                4, ax0_0_0_ax1_0_0_fused + ax1_0_3_init + ax1_0_4_init
                            )
                            T.reads()
                            T.writes(
                        ...
                        for ax2_0_1 in T.serial(1):
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("A_reindex_shared_wmma.matrix_a_o"):
                                    v0_o, v1_o = T.axis.remap("SS", [ax0_0_1_ax1_0_1_fused, ax1_0])
                                    T.reads(
                                        A_reindex_shared[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                                        ]
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("B_reindex_shared_wmma.matrix_b_o"):
                                    v0_o, v1_o = T.axis.remap("SS", [ax0_0, ax0_0_0_ax1_0_0_fused])
                                    T.reads(
                                        B_reindex_shared[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                                        ]
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(
                                ...
                                with T.block("C_o_update"):
                                    v0_o = T.axis.spatial(
                                        4, ax0_0_4 + ax0_0_1_ax1_0_1_fused + ax0_0_3
                                    )
                                    v1_o = T.axis.spatial(
                                        4, ax0_0_0_ax1_0_0_fused + ax1_0_3 + ax1_0_4
                                    )
                    ...
                    for ax0_0, ax1_0 in T.grid(1, 1):
                        with T.block("C_reindex_shared_wmma.accumulator_o"):
                            v0_o, v1_o = T.axis.remap(
                                "SS", [ax0_0_1_ax1_0_1_fused, ax0_0_0_ax1_0_0_fused]
                            )
                            T.reads(
                                C_reindex_shared_wmma_accumulator[
                                    v0_o * 16 : v0_o * 16 + 16, v1_o * 16 : v1_o * 16 + 16
                    ...
                    for ax1_1 in T.thread_binding(1, thread="threadIdx.y"):
                        for ax1_2 in T.thread_binding(32, thread="threadIdx.x"):
                            with T.block("C_reindex_shared"):
                                ...
                                v0 = T.axis.spatial(64, ax0_0_1_ax1_0_1_fused * 16 + ax0)
                                v1 = T.axis.spatial(
                                    64,
                                    ax0_0_0_ax1_0_0_fused * 16 + (ax1_0 * 32 + ax1_1 * 32 + ax1_2),
                                )
...
def apply_trace(sch: tir.Schedule) -> None:
    ...
    v24, v25, v26, v27, v28 = sch.sample_perfect_tile(
        loop=l21, n=5, max_innermost_factor=4, decision=[1, 4, 1, 1, 1]
    )
    ...
    v34, v35, v36, v37, v38 = sch.sample_perfect_tile(
        loop=l22, n=5, max_innermost_factor=4, decision=[4, 1, 1, 1, 1]
    )
    ...
    l148, l149, l150, l151 = sch.split(
        loop=l147, factors=[None, 1, 32, 8], preserve_unit_iters=True
    )
    ...
    l157, l158, l159, l160 = sch.split(
        loop=l156, factors=[None, 1, 32, 4], preserve_unit_iters=True
    )
    ...
    sch.annotate(block_or_loop=l169, ann_key="pragma_auto_unroll_max_step", ann_val=16)
    ...
    sch.annotate(block_or_loop=l177, ann_key="pragma_auto_unroll_max_step", ann_val=16)
    ...
    sch.annotate(block_or_loop=l199, ann_key="pragma_auto_unroll_max_step", ann_val=16)
    ...
    sch.annotate(block_or_loop=l214, ann_key="pragma_auto_unroll_max_step", ann_val=16)
...
-----------------------------------------------------------------------------------------------------
  0 | main | 262144 |      1 |       117.4451 |       2.2321 |                2.2321 |   1000 |    Y
-----------------------------------------------------------------------------------------------------
Total trials: 1000
Total latency (us): 2.23206

best tuning record is 0, min_run_time is 2.232055819943772e-06
"""

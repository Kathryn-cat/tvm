...
def apply_trace(sch):
  ...
  sch.transform_layout(block=b0, buffer=("read", 1), index_map=lambda vj, vk: (vk, vj,))
  ...
  v81 = sch.sample_categorical(candidates=[1, 2, 4, 8], probs=[0.25, 0.25, 0.25, 0.25], decision=3)
  ...
  v135 = sch.sample_categorical(candidates=[0, 16, 64, 512, 1024], probs=[0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 0.20000000000000001], decision=1)
  ...
  l140, l141, l142, l143 = sch.split(loop=l139, factors=[None, 4, 32, 4], preserve_unit_iters=True)
  ...
  l149, l150, l151, l152 = sch.split(loop=l148, factors=[None, 4, 32, 8], preserve_unit_iters=True)
